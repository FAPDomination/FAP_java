            ...
            for (int j = 0; j < randCells.size(); j++) {
                ...
                if (c.isMinerSing()) {
                    ...
                    if (c != null && c.getOccupied() == null && c.getType() == 1) {
                        ...
                        this.setCurrent(c);
                        this.setDrawn(c);
                        this.setX(CMap.giveTalePosition(this.getCurrent().getI(), this.getCurrent().getJ())[0] +
                                  Params.OFFX);
                        this.setY(CMap.giveTalePosition(this.getCurrent().getI(), this.getCurrent().getJ())[1] +
                                  Params.OFFY);
                        this.setI(c.getI());
                        this.setJ(c.getJ());
                        c.activateCell(this);
