...
public class GameConfig implements Serializable {
    ...
    public GameConfig(String whoIsPlaying, String wichTeam, String controlers, String isFSM, boolean randStart,
                      int nmap, int victScore, double victTile, int victTime, int adv, String WMCellHash) {
    ...
    public Game createGame() {
        Game g =
            new Game(whoIsPlaying, wichTeam, controlers, isFSM, randStart, nmap, victScore, victTile, victTime, adv);
